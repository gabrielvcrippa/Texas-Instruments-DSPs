...
void Setup_GPIO(void){
    ...
    // GPIO10 EPWM6A Pin76 J8
    GpioCtrlRegs.GPAGMUX1.bit.GPIO10 = 0;
    GpioCtrlRegs.GPAMUX1.bit.GPIO10 = 1;  // EPWM6A - anti windup DI21
...
void Setup_ePWM(void){
    ...
    CpuSysRegs.PCLKCR2.bit.EPWM6 = 1;                 // Enable EPWM6 clock
    ...
    EPwm1Regs.TBCTL.bit.SYNCOSEL = TB_CTR_ZERO;            // Emite um pulso para que outros ePWM sincronizem com o ePWM1 quando o contador zerar
    ...
    EPwm1Regs.TBPRD = __divf32(SYSCLK, 4*Fs);              // TBPRD = ((200e6)/(4*20e3)) = 2500
...
//    EPwm1Regs.CMPCTL.bit.SHDWBMODE = CC_SHADOW;
    ...
    // ------------------- EPWM6 -------------------- //
      ...
      // TIME-BASE
      EPwm6Regs.TBCTL.bit.CTRMODE = TB_COUNT_UPDOWN;    // Count up and down mode
      EPwm6Regs.TBCTL.bit.PHSEN = TB_DISABLE;           // Phase Register Enable
      EPwm6Regs.TBCTL.bit.SYNCOSEL = TB_CTR_ZERO;       // ePWM3 module to synchronize with ePWM1
      EPwm6Regs.TBCTL.bit.HSPCLKDIV = TB_DIV1;          // High Speed TB Clock Prescale (SYSCLK = /1)
      EPwm6Regs.TBCTL.bit.CLKDIV = TB_DIV1;             // TB Clock Prescale (SYSCLK = /1)
      EPwm6Regs.TBCTR = 0x0000;                         // Clear counter
      EPwm6Regs.TBPRD = EPwm1Regs.TBPRD;                // EPWM3 with the same sampling frequency as EPWM1

      // COMPARE
      EPwm6Regs.CMPCTL.bit.LOADAMODE = CC_CTR_ZERO_PRD; // CMPA value is loaded when the counter is still ZERO and PRD
      ...
      EPwm6Regs.AQCTLA.bit.CAU = AQ_CLEAR;              // PWM output pin in a Low logic level (0)
      EPwm6Regs.AQCTLA.bit.CAD = AQ_SET;                // PWM output pin in a High logic level (1)
      ...
      // EPwm6Regs.DBRED.bit.DBRED = 10;                // RED = 20 TBCLKs
      // EPwm6Regs.DBFED.bit.DBFED = 10;                // FED = 20 TBCLKs
