...
void Setup_ePWM(void){
    ...
    #define Fs 100e3                                    // Sampling Frequency
...
//    EPwm1Regs.CMPCTL.bit.SHDWBMODE = CC_SHADOW;
    ...
    EPwm1Regs.ETSEL.bit.SOCASEL = ET_CTR_ZERO;              // Generates an output signal when the EPWM counter reaches zero and PRD
